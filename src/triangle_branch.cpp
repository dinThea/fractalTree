...
triangle_branch::triangle_branch( double minLength, double length, double width, double angle, branch* parent ) :
    branch( minLength, length, width, angle)
{
...
void triangle_branch::subdivide() {
    ...
    branch* b2 = new triangle_branch( get_minLength(), get_length() / 2 , get_width() / 2,  get_angle() + 2*PI/3, this );
    branch* b3 = new triangle_branch( get_minLength(), get_length() / 2 , get_width() / 2,  get_angle() - 2*PI/3, this );
